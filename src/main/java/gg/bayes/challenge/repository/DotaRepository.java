...
public interface DotaRepository extends JpaRepository<Match, Long>{
	...
	@Query(value = "SELECT new gg.bayes.challenge.rest.model.HeroSpells(s.spell, CAST(count(*) as integer)) FROM Spell s, Match m "
	...
	@Query(value="select new gg.bayes.challenge.rest.model.HeroDamage(d.target, "
